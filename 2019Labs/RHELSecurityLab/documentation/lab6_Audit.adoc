...
. The `aureport` and `ausearch` tools may be used together. Suppose you wanted to who was
...
events for a specific login whenevr you pass the *--proof* command line option. This is helpful
